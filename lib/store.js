 ...
 */
const { initAuthCreds, BufferJSON, proto } = (await import('@onedevil405/baileys')).default

/**
 * @param {import('@onedevil405/baileys').WASocket | import('@onedevil405/baileys').WALegacySocket}
 */
function bind(conn) {
    // Prevent binding listeners multiple times for the same connection
    if (conn._storeBound) return
    conn._storeBound = true
    if (!conn.chats) conn.chats = {}
    /**
     * 
    * @param {import('@onedevil405/baileys').Contact[]|{contacts:import('@onedevil405/baileys').Contact[]}} contacts 
     * @returns 
     */
