...
const fileTypeFromBuffer = fileType.fileTypeFromBuffer || fileType.fileTypeFromBuffer
...
/**
 * @type {import('@onedevil405/baileys')}
 */
const {
...
} = (await import('@onedevil405/baileys')).default

export function makeWASocket(connectionOptions, options = {}) {
    /**
    * @type {import('@onedevil405/baileys').WASocket | import('@onedevil405/baileys').WALegacySocket}
     */
    ...
    */
	...
	let fsizedoc = '1'.repeat(10)    
        ...
        sendFile: {
             ...
             * @param {import('@onedevil405/baileys').proto.WebMessageInfo} quoted
             * @param {Boolean} ptt
            ...
            async value(jid, path, filename = '', caption = '', quoted, ptt = false, options = {}) {
                ...
                /**
                 * @type {import('@onedevil405/baileys').proto.WebMessageInfo}
                 */
                let m
                try {
...
END:VCARD
        ...
        sendButton: {
            ...
            async value(jid, text = '', footer = '', buffer, buttons, quoted, options) {
                ...
                else if (buffer) try { let type = await conn.getFile(buffer); buffer = type.data } catch { buffer = null }
        ...
        cMod: {
             ...
             * cMod
             * @param {String} jid 
             * @param {import('@onedevil405/baileys').proto.WebMessageInfo} message 
             * @param {String} text 
             * @param {String} sender 
             * @param {*} options 
             * @returns 
        ...
        loadMessage: {
             ...
             * @returns {import('@onedevil405/baileys').proto.WebMessageInfo}
             */
            value(messageID) {
        ...
        processMessageStubType: {
             ...
             * @param {import('@onedevil405/baileys').proto.WebMessageInfo} m 
             */
            async value(m) {
                ...
                for (const message of m) {
                    try {
                        ...
                        if (message.message?.[mtype]?.contextInfo?.quotedMessage) {
                            /**
                             * @type {import('@onedevil405/baileys').proto.IContextInfo}
                             */
                            let context = message.message[mtype].contextInfo
                            let participant = conn.decodeJid(context.participant)
                            const remoteJid = conn.decodeJid(context.remoteJid || participant)
                            /**
                             * @type {import('@onedevil405/baileys').proto.IMessage}
                             * 
                             */
